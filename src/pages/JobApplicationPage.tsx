            ...
            <div className="bg-white rounded-xl border border-gray-200 p-3 md:p-8">
              ...
              <div className="mt-4 md:mt-6">
                <button
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 md:px-5 py-2 md:py-2.5 rounded-lg font-semibold transition-colors shadow-sm text-sm"
                >
                  Apply for this position
                </button>
                <div className="mt-3 md:mt-4 text-center">
                  <div className="text-xs md:text-sm text-gray-500">
                    Powered by <span className="font-semibold text-gray-900">Hiringg.ai</span>
                  </div>
                </div>
              </div>
            </div>
